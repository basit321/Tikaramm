...
import { StyleSheet, Text, View, Dimensions, ImageBackground,BackHandler, TouchableOpacity,Alert,TextInput } from 'react-native';
...
export default function RestaurantCart({navigation}) {
...
borderColor: 'rgba(0, 0, 0, 0.1)',
             ...
             <View style={{backgroundColor:"#FF9D52",height:80,}}>
 ...
 cancel
            ...
            <View style={{backgroundColor:"#F6F6F6",flex:1}}>
               ...
               <TouchableOpacity activeOpacity={1}   onPress={()=>{Setsaddnewaddress(true)}} >
                        <Text style={{ color: "#FF9D52", fontFamily: 'arabicBold', fontSize:14 ,
